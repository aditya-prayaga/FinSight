...
divide_features_and_labels_task = PythonOperator(
    ...
    provide_context=True,
    op_args=[visualize_training_refined_data_task.output],
    op_kwargs={'eval_df': apply_transformation_eval_task.output, 'test_df': apply_transformation_test_task.output},
    dag=dag,
)
...
load_and_predict_task = PythonOperator(
    ...
    provide_context=True,
    op_args=[hyper_parameter_tuning_task.output, divide_features_and_labels_task.output['x'], training_task.output, ],
